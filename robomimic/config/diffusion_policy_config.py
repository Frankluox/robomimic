...
class DiffusionPolicyConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.optim_params.policy.learning_rate.warmup_steps = 500 # 0 # number of warmup steps (used by "cosine" scheduler)
        ...
        # horizon parameters
        self.algo.horizon.observation_horizon = 2 # 1
        self.algo.horizon.action_horizon = 8 # 10
        self.algo.horizon.prediction_horizon = 16 # 16
        
        # UNet parameters
        self.algo.unet.enabled = True
        self.algo.unet.diffusion_step_embed_dim = 256 # 128
        ...
        self.algo.ddpm.num_train_timesteps = 100 # 20
        self.algo.ddpm.num_inference_timesteps = 100 # 20
